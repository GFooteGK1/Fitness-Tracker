...
export default function ConnectivityIndicator() {
  ...
  return (
    <>
      ...
      {!isOnline && (
        <div role="status" className="fixed top-0 left-0 right-0 z-[60] app-notice-warning border-b border-[var(--warning-line)] text-center py-1.5 text-xs font-medium shadow-sm">
      ...
      {/* Reconnected toast */}
      {showReconnected && (
        <div className="fixed top-4 left-4 right-4 mx-auto w-fit max-w-[calc(100%-2rem)] z-[60]">
          <div role="status" className="app-notice app-notice-success shadow-lg text-sm font-medium flex items-center gap-2">
