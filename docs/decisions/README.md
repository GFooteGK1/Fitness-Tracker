...
| [ADR-0002](ADR-0002-food-photo-eval-golden-set.md) | Food-photo eval golden-set composition and harness design | Accepted |
| [ADR-0003](ADR-0003-adaptive-coach-state-and-authority.md) | Adaptive coach state, memory, and authority boundaries | Accepted |
